  ...
  data() {
    return {
      ...
      options: {
        ...
        particles: {
          links: {
            distance: 20, // maximum distance for linking the particles
            enable: true, // enabling this will make the particles linked together
          },
          move: {
            enable: true, // enabling this will make particles move in the canvas
            speed: { min: 0, max: 1 }, // using a range in speed value will make particles move in a random speed between min/max values, each particle has its own value, it won't change over time by default
          },
          opacity: {
            value: { min: 0.05, max: 0.1 }, // using a different opacity, to have some semitransparent effects
          },
          size: {
